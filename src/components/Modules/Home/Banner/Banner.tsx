  ...
  return (
    <section className="relative w-full py-5 border border-gray-200 rounded-md text-center">
      <div className=" mx-auto px-6">
        <h1 className="text-4xl font-extrabold mb-5 leading-tight font-title">
          Discover the Perfect Medicine for You
        </h1>
        <p className="text-xl mb-8 opacity-80 font-description">
        ...
        <Card className="mx-auto  shadow-lg rounded-lg overflow-hidden mb-5">
          <CardContent className="flex items-center gap-4 py-4">
            ...
            />
            <Button className=" transition duration-200 ease-in-out py-3 px-6 rounded-lg flex items-center font-description">
